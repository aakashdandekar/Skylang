...
exports.FOREIGN_MODULES = exports.FOREIGN_MODULE_ALIASES = void 0;
exports.normalizeModuleName = normalizeModuleName;
exports.getForeignModule = getForeignModule;
exports.FOREIGN_MODULE_ALIASES = {
    // JS aliases
    'express': 'express',
    'expressjs': 'express',
    'express.js': 'express',
...
function normalizeModuleName(rawName) {
    ...
    return exports.FOREIGN_MODULE_ALIASES[clean] || exports.FOREIGN_MODULE_ALIASES[lower] || clean;
}
function getForeignModule(moduleName, bridge) {
    const norm = normalizeModuleName(moduleName);
    if (exports.FOREIGN_MODULES[norm]) {
        return exports.FOREIGN_MODULES[norm];
    }
    if (exports.FOREIGN_MODULES[norm.toLowerCase()]) {
        return exports.FOREIGN_MODULES[norm.toLowerCase()];
    }
    return undefined;
}
