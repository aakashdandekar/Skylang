...
export class SkylangDocumentSymbolProvider implements vscode.DocumentSymbolProvider {
        ...
        for (let i = 0; i < lines.length; i++) {
            ...
            if (classMatch) {
                ...
                const selRange = new vscode.Range(
                    ...
                    new vscode.Position(i, (col >= 0 ? col : 0) + className.length)
                );
            ...
            if (fnMatch) {
                ...
                const selRange = new vscode.Range(
                    new vscode.Position(i, col >= 0 ? col : 0),
                    new vscode.Position(i, (col >= 0 ? col : 0) + fnName.length)
                );
            ...
            if (externMatch) {
                ...
                const selRange = new vscode.Range(
                    new vscode.Position(i, col >= 0 ? col : 0),
                    new vscode.Position(i, (col >= 0 ? col : 0) + extName.length)
                );
                const extSym = new vscode.DocumentSymbol(
                    extName,
                    `extern (${extParams})`,
                    vscode.SymbolKind.Function,
                    range,
            ...
            if (currentClassSymbol && i <= classEndLine) {
                ...
                if (line.startsWith('init') && line.includes('{')) {
                    ...
                    const selRange = new vscode.Range(
                        new vscode.Position(i, col >= 0 ? col : 0),
                        new vscode.Position(i, (col >= 0 ? col : 0) + 4)
                    );
                    const params = this.extractTakesParams(lines, i + 1);
                    const initSym = new vscode.DocumentSymbol(
                        'init',
                        `(${params.join(', ')})`,
                ...
                if (
                    ...
                    const selRange = new vscode.Range(
                        new vscode.Position(i, col >= 0 ? col : 0),
                        new vscode.Position(i, (col >= 0 ? col : 0) + methodName.length)
                    );
                    const params = this.extractTakesParams(lines, i + 1);
                ...
                if (fieldMatch) {
                    ...
                    const selRange = new vscode.Range(
                        new vscode.Position(i, col >= 0 ? col : 0),
                        new vscode.Position(i, (col >= 0 ? col : 0) + fieldName.length)
                    );
            ...
            if (!currentClassSymbol || i > classEndLine) {
                ...
                if (walrusMatch && walrusMatch[1] !== '_') {
                    ...
                    const selRange = new vscode.Range(
                        new vscode.Position(i, col >= 0 ? col : 0),
                        new vscode.Position(i, (col >= 0 ? col : 0) + varName.length)
                    );
                    symbols.push(
                        new vscode.DocumentSymbol(varName, 'variable', vscode.SymbolKind.Variable, range, selRange)
                    );
                }
                ...
                if (typedMatch) {
                    ...
                    symbols.push(
                        new vscode.DocumentSymbol(varName, typeTok, vscode.SymbolKind.Variable, range, selRange)
                    );
                }
    ...
    private findBlockRange(document: vscode.TextDocument, startLine: number): vscode.Range {
...
export class SkylangWorkspaceSymbolProvider implements vscode.WorkspaceSymbolProvider {
                    ...
                    if (fnMatch && (!query || fnMatch[1].toLowerCase().includes(query.toLowerCase()))) {
                        symbols.push(
                            new vscode.SymbolInformation(
                                ...
                                vscode.SymbolKind.Function,
                                '',
                                new vscode.Location(file, new vscode.Position(i, line.indexOf(fnMatch[1])))
                            )
                        );
                    }
                    ...
                    if (classMatch && (!query || classMatch[1].toLowerCase().includes(query.toLowerCase()))) {
                        symbols.push(
                            new vscode.SymbolInformation(
                                ...
                                vscode.SymbolKind.Class,
                                '',
                                new vscode.Location(file, new vscode.Position(i, line.indexOf(classMatch[1])))
                            )
                        );
                    }
                    ...
                    if (externMatch && (!query || externMatch[1].toLowerCase().includes(query.toLowerCase()))) {
                        symbols.push(
                            new vscode.SymbolInformation(
                                ...
                                vscode.SymbolKind.Function,
                                'extern',
                                new vscode.Location(file, new vscode.Position(i, line.indexOf(externMatch[1])))
                            )
                        );
                    }
                }
